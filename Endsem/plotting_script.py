...
filename     = "q3.txt"              #filename : This is name of the file containing the x and y values
Plot_Title   = "High-Pass-Filter"
x_axis_label = "$Frequency$"
y_axis_label = "$Gain(db)$"
number_of_curves_in_plot = 1
legend_list = ["$Gain_{db}$"]
LOG_OF_X = True                         #LOG_OF_X : x axis will be logarithmic if LOG_OF_X is 'True'
is_first_order_derivative = False
#_______________________________________________________________________________________________________________

x_axis_colum_number = 0                    #this is column no. from which actual data start. It lowest value is 0.
...
if __name__ == '__main__':
    ...
    plt.show()
    #plt.savefig('Plots/'+Plot_Title.replace(" ", "-")+'.png')
