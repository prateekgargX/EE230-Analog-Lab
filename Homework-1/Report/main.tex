...
\lstdefinelanguage{SPICE}{
  keywords={tran,ac,dc, meas,plot,print,control,run,end,endc},
  morecomment=[l]{*},
  morecomment=[l]{\$},
  morecomment=[s]{/*}{*/},
  morestring=[b]',
  morestring=[b]",
  ndkeywords={r,l,c,v,vdb},
...
\input{RC_lowpass_Filter.tex}
\input{RC_Highpass_Filter.tex}
\input{RC_Bandpass_Filter.tex}
\input{RLC_Bandpass_Filter.tex}
